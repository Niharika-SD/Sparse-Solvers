%-------------------------------------------------------------------
% This code generates Figure 4cd (Approx.) of the following paper: 
...
for count = 1:total_count
    ...
    [weights,used,sigma2,errbars,basis] = BCS_fast_rvm(A,y,initsigma2,1e-8,1,0,0.1);
...
save DataFig04cd_approx.mat err;
beep;
disp('Done!');
