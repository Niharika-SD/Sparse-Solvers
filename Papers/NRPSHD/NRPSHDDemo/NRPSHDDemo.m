...
% -------------------------------------------------------
LastFigureNo = 6;
PaperName = 'Neighborliness of Randomly-Projected Simplices in High Dimensions';
MakeFigureFilePrefix = 'NRPSHDFig';
%--------------------------------------------------------
global NRPSHDFIGNUM 
NRPSHDFIGNUM = 0;
clc; help('NRPSHDIntro');
NRPSHDPath
...
uicontrol('tag','newWindow', 'style','checkbox', ...
    ...
    'callback','NRPSHDDemoNew(''NewWindow'')');
% 
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','NRPSHDDemo(''CloseAllDemo'')');
