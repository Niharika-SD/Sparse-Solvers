...
% -------------------------------------------------------
LastFigureNo = 11;
PaperName = 'Breakdown Point of Model Selection When the Number of Variables Exceeds the Number of Observations';
MakeFigureFilePrefix = 'MSNVENOFig';
%--------------------------------------------------------
MSNVENOPath
global MSNVENOFIGNUM 
MSNVENOFIGNUM = 0;
clc; help('MSNVENOIntro');
...
elseif  isequal(action,'seecode'),
    ...
    s = ['edit', ' ', strcat(MakeFigureFilePrefix, edit1)];
    eval(s);
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','MSNVENODemo(''CloseAllDemo'')');
