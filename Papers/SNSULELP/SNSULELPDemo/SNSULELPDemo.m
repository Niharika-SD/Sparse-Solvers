...
% -------------------------------------------------------
LastFigureNo = 1;
PaperName = 'Sparse Nonnegative Solutions of Underdetermined Linear Equations by Linear Programming';
MakeFigureFilePrefix = 'SNSULELP';
%--------------------------------------------------------
global SNSULELPFIGNUM 
SNSULELPFIGNUM = 0;
clc; help('SNSULELPIntro');
SNSULELPPath
...
if  isequal(action,'NewWindow'),
    ...
    if IfNewWindow,SNSULELPDemo;end
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','SNSULELPDemo(''CloseAllDemo'')');
