...
% -------------------------------------------------------
LastFigureNo = 18;
PaperName = 'Sparse Solution of Underdetermined Linear Equations by Stagewise Orthogonal Matching Pursuit';
MakeFigureFilePrefix = 'StOMPFigure';
%--------------------------------------------------------
StOMPPath
global StOMPFIGNUM 
StOMPFIGNUM = 0;
...
uicontrol(  'style','pushbutton',  'units','normal', ...
    ...
    'fontsize',fs, 'callback','StOMPDemo(''CloseAllDemo'')');
...
DeleteSubplots;
%set(gcf,'Visible', 'off');
edit1 = get(findobj(gcf,'tag','edit1'),'value')+1;
IfAddTitle = get(findobj(gcf,'tag','iftitle'),'value');
IfCompute = get(findobj(gcf,'tag','IfCompute'),'value');
%IfNewWindow = get(findobj(gcf,'tag','newWindow'),'value');
IfNewWindow = 0;
