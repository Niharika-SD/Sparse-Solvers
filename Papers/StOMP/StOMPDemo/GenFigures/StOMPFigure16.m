% Figure 16: BER performance of Error-Correcting Codes with ITSP.
%
% Data Dependencies:
%   DataFig16.mat (Created by GenDataECC(256,4,100,1024,'DataFig16.mat'))
%
...
axis([kArr(1) kArr(length(kArr)) 0 0.4]);
