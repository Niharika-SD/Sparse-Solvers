...
subplot(3,5,1); AutoImage(I_LIN{1}); title(['(a) Linear 1, n=' num2str(4^j1)]); axis off;
subplot(3,5,2); AutoImage(I_LIN{2}); title(['(b) Linear 2, n=' num2str(4^j1)]); axis off;
subplot(3,5,3); AutoImage(I_LIN{3}); title(['(c) Linear 3, n=' num2str(4^j1)]); axis off;
subplot(3,5,4); AutoImage(I_LIN{4}); title(['(d) Linear 4, n=' num2str(4^j1)]); axis off;
subplot(3,5,5); AutoImage(I_LIN{5}); title(['(e) Linear 5, n=' num2str(4^j1)]); axis off;
subplot(3,5,6); AutoImage(I_BCS{1}); title(['(f) ST 1, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,7); AutoImage(I_BCS{2}); title(['(g) ST 2, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,8); AutoImage(I_BCS{3}); title(['(h) ST 3, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,9); AutoImage(I_BCS{4}); title(['(i) ST 4, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,10); AutoImage(I_BCS{5}); title(['(j) ST 5, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,11); AutoImage(IM_BCS{1}); title(['(k) MT 1, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,12); AutoImage(IM_BCS{2}); title(['(l) MT 2, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,13); AutoImage(IM_BCS{3}); title(['(m) MT 3, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,14); AutoImage(IM_BCS{4}); title(['(n) MT 4, n=' num2str(Ndetail+4^j0)]); axis off;
subplot(3,5,15); AutoImage(IM_BCS{5}); title(['(o) MT 5, n=' num2str(Ndetail+4^j0)]); axis off;
...
%
save DataFig05.mat I_LIN I_BCS IM_BCS E_LIN E_BCS EM_BCS t_BCS tm_BCS Ndetail Mdetail j0 j1 ML;
disp('Done!');
